...
void HAL_LCD_SpiInit(void)
{
    ...
    EUSCI_B0->CTLW0 =   EUSCI_B_CTLW0_CKPH |        // phase of 1
                        ...
                        EUSCI_B_CTLW0_MST |         // set SPI to master
                        EUSCI_B_CTLW0_MODE0 |       // SPI 3 pin mode
                        EUSCI_B_CTLW0_SYNC |        // set synchronous mode
                        EUSCI_B_CTLW0_SSEL__SMCLK | // use SMCLK
                        //EUSCI_B_CTLW0_STEM |        // UCxSTE digital output
                        EUSCI_B_CTLW0_SWRST;        // remain USCI state machine in reset
